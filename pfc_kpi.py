...
def collect_data(upload_files):
    ...
    for upload_file in upload_files:
        ...
        if upload_file.name.endswith('.xlsx'):
            ...
            match_1 = pd.read_csv(f'data/EDF_U19_Match1.csv')
            match_2 = pd.read_csv(f'data/EDF_U19_Match2.csv')
            match_3 = pd.read_csv(f'data/EDF_U19_Match3.csv')
